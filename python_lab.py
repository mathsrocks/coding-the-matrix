...
representation_dict = {x:(x//base**2, (x-(x//base**2)*base**2)//base, x-(x//base**2)*base**2-(x-(x//base**2)*base**2)//base*base) for x in range(base**3)}
...
listdict2dict = {names[i]:id2salary[i] for i in range(len(names)) if i in id2salary.keys()}
